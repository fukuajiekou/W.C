        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li class="active"><a href="diary?action=addDiary"><i class="icon-pencil"></i>&nbsp;写笔记</a></li>
              <li class="active"><a href="diaryType?action=list"><i class="icon-book"></i>&nbsp;笔记分类管理</a></li>
